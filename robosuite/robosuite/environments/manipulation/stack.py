...
class Stack(SingleArmEnv):
    ...
    def __init__(
        ...
        placement_initializer1=None,
        placement_initializer2=None,        
        has_renderer=False,
        ...
        self.placement_initializer1 = placement_initializer1
        self.placement_initializer2 = placement_initializer2
    ...
    def staged_rewards(self):
        ...
        cubeA_lifted = cubeA_height > table_height + 0.05
        ...
        if cubeA_lifted:
            ...
            r_lift += 0.5 * (1 - np.tanh(10.0*horiz_dist)) * 1
    ...
    def _load_model(self):
        ...
        # Create placement initializer 1
        if self.placement_initializer1 is not None:
            self.placement_initializer1.reset()
            self.placement_initializer1.add_objects(self.cubeA)
        else:
        ...
        # Create placement initializer 2
        if self.placement_initializer2 is not None:
            self.placement_initializer2.reset()
            self.placement_initializer2.add_objects(self.cubeB)
        else:
    ...
    def _reset_internal(self):
        ...
        if not self.deterministic_reset:
            ...
            object_placements1 = self.placement_initializer1.sample()
            object_placements2 = self.placement_initializer2.sample()
            object_placements = {**object_placements1, **object_placements2}
