...
o1 = pickle.load(open("ours/lift/rewards1.pkl", "rb"))
o2 = pickle.load(open("ours/lift/rewards2.pkl", "rb"))
o3 = pickle.load(open("ours/lift/rewards3.pkl", "rb"))
o4 = pickle.load(open("ours/lift/rewards4.pkl", "rb"))
o5 = pickle.load(open("ours/lift/rewards5.pkl", "rb"))
...
ms, ss = np.mean(sac, axis=0), np.std(sac, axis=0) / np.sqrt(10)
